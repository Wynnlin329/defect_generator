...
- Primary domain 為`web`；project已導入Web Stage 1 foundation、Stage 2 required browser verification與Optional visual reference mapping assets。Optional runtime diagnostics及其他未導入/Later能力維持core-only fallback。
