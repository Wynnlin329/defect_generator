...
- Status：retrofit completed / TASK-001至TASK-008 closed
- Primary domain：`web`
...
- [x] 依TASK-007使用TASK-006既有證據完成report-only mapping smoke；本次未重新執行Browser verification。
- [x] 依TASK-008同步Project Harness v1.2.1；`node_modules`存在時兩種project-check模式均通過。
